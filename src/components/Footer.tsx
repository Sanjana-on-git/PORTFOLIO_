          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-slate-400">
                <a href="mailto:alex@example.com" className="hover:text-indigo-400 transition-colors">alex@example.com</a>
              </li>
              <li className="text-slate-400">
                <a href="tel:+15551234567" className="hover:text-indigo-400 transition-colors">+1 (555) 123-4567</a>
              </li>
              <li className="text-slate-400">
                San Francisco, CA
              </li>
