...
export const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    {
      ...
      description:
        'A React-based educational platform with fun, accessible games to help children with dyslexia improve reading and writing. Features include phonics and word-building games, progress tracking, and blogs for parents and educators.',
      image: Lexi,
    ...
    },
    {
      ...
      description:
        'A sleek and responsive e-commerce platform built using React, Tailwind CSS, and JavaScript. This project delivers a polished shopping experience with smooth animations, dynamic product listings, and interactive filtering systems.',
      image: buybetter,
    ...
    },
    {
      ...
      description:
        'A responsive weather web app platform that provides real-time weather updates and forecasts. Built with HTML,CSS, and JavaScript, it features a user-friendly interface and interactive elements for an engaging experience.',
      image: weather,
    ...
    },
    {
      ...
      description:
        'The urban palette is a restaurant website that showcases a modern and elegant design. It features a user-friendly interface, responsive layout, and interactive elements to enhance the dining experience.',
      image: urbanPalette,
      technologies: ['React', 'Typescript', 'Javascript'],
      category: ['web'],
    ...
    },
    {
      ...
      description:
        'The Gliding Fork is a UI/UX project that showcases a modern and elegant design for a food ordering website.',
      image: TGF,
      technologies: ['Figma', 'UI/UX Design', 'Prototyping'],
      category: ['ui'],
      demoUrl:
        'https://www.figma.com/design/gL8NarMxqTloKvOqNbKeqj/TheGlidingFork?node-id=0-1&p=f&t=G58hSSMJjw0fHbKv-0',
      githubUrl: '#',
    },
    {
      id: 6,
    ...
    {
      id: 7,
      title: 'Lexi-Gamified Learning (UI/UX)',
      description:
        'Designed an interactive gamified learning platform tailored for dyslexic children, focusing on accessibility, engagement, and ease of use.',
      image: Lexi,
      technologies: ['Figma', 'Prototyping', 'Wireframing', 'UI/UX Design'],
      category: ['ui'],
      demoUrl:
        'https://www.figma.com/proto/GVJBPNWJtW3cHkCVxkSUUS/Untitled?node-id=1-2',
      githubUrl: '#',
    },
    {
      id: 8,
      ...
      description:
        'Created child-friendly authentication pages (Login, Signup, and Forgot Password) for an EdTech platform designed for young learners.',
      image: EdTech,
      technologies: ['Figma', 'Prototyping', 'Wireframing', 'UI/UX Design'],
      category: ['ui'],
    ...
    },
    {
      ...
      description:
        'Designed an intuitive Mentor Dashboard for an EdTech platform to help mentors track student progress and manage learning activities.',
      image: Dashboard,
      technologies: ['Figma', 'Prototyping', 'Wireframing', 'UI/UX Design'],
      category: ['ui'],
      demoUrl:
        'https://www.figma.com/design/e03jFJqYr4cTc21x7z8SVe/Untitled?node-id=0-1&p=f&t=2BjZZRKhGlUHN70e-0',
      githubUrl: '#',
    },
    {
      id: 10,
      ...
      description:
        'I reimagined Monster Energy with a striking new look that pushes the brand beyond its classic identity.',
      image: Monster,
      technologies: ['Figma', 'Prototyping', 'Wireframing', 'UI/UX Design'],
      category: ['ui'],
      demoUrl:
  ...
  return (
    <>
      <Helmet>
        <title>Projects | Sanjana Chatterjee</title>
        <meta
          name="description"
          content="Portfolio projects by Sanjana, a frontend developer skilled in React, TypeScript, and Tailwind."
        />
      </Helmet>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredProjects.map((project) => (
              ...
              >
                {/* Image Container with native Tailwind aspect */}
          ...
          <div className="text-center mt-12">
            <a
              href="https://github.com/Sanjana-on-git?tab=repositories&type=source&sort="
              target="_blank"
              rel="noopener noreferrer"
